"""Resume and verify the official GTNH 2.9.0-beta-2 server test fixture."""
...
URL = (
    "https://downloads.gtnewhorizons.com/ServerPacks/betas/"
    "GT_New_Horizons_2.9.0-beta-2_Server_Java_17-25.zip"
)
EXPECTED_SIZE = 513_643_195
EXPECTED_ETAG = '"28f5afb22c322a082cdce82522818cc9-98"'
...
def main() -> None:
    ...
    part_directory = download_directory / "gtnh-2.9.0-beta-2-server.parts"
    destination = download_directory / "GT_New_Horizons_2.9.0-beta-2_Server_Java_17-25.zip"
