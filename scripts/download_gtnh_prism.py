"""Resume and verify the official GTNH 2.9.0-beta-2 Prism compatibility fixture."""
...
URL = (
    "https://downloads.gtnewhorizons.com/Multi_mc_downloads/betas/"
    "GT_New_Horizons_2.9.0-beta-2_Java_17-25.zip"
)
EXPECTED_SIZE = 680_333_339
EXPECTED_ETAG = '"1427c85b47284b54a36ea9b2ceb33d18-130"'
...
def main() -> None:
    ...
    part_directory = download_directory / "gtnh-2.9.0-beta-2-prism.parts"
    destination = download_directory / "GT_New_Horizons_2.9.0-beta-2_Java_17-25.zip"
